...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_practice__ = __webpack_require__(336);
...
Object(__WEBPACK_IMPORTED_MODULE_1__libs_binder__["a" /* binder */])({
    bounds: {
        "html": __WEBPACK_IMPORTED_MODULE_2__modules_module__["a" /* constants */],
        ".sample": __WEBPACK_IMPORTED_MODULE_3__modules_practice__["a" /* practice */]
    },
    runTests: false
});
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = practice;
...
function practice() {
    ...
    /*let sample = new Vue({
        el: ".sample",
         //хранятся все базовые поля нашего экземпляра
        data: {
            name: "Default",
            showName: true,
        },
    ...
    //    sample.b()
    //    sample.a()
    //    !! без обращения к свойствам computed ...
